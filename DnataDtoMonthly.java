...
public class DnataDtoMonthly {
	...
	public DnataDtoMonthly(String date, int offered, int answered, int transferred, int avgHandlingTime) {
		super();
		this.date = date;
	...
	public String toString() {
		return "DnataDtoMonthly [date=" + date + ", offered=" + offered + ", answered=" + answered + ", transferred="
